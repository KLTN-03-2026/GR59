        ...
        <div className={styles.filterHeader}>
          <div className={styles.tabGroup}>
            {[
              ...
              { id: 'security', icon: ShieldCheck, label: 'Bảo mật & Tài khoản' },
            ...
            <div className={styles.profileLayout}>
              ...
              <div className={styles.formGrid}>
                <div className={styles.formGroup}>
                  ...
                  <input type="text" defaultValue="Quản trị viên" className={styles.input} />
                </div>
                <div className={styles.formGroup}>
                  <label>Vai trò</label>
                  <input type="text" defaultValue="Super Admin" disabled className={styles.input} />
                </div>
                <div className={`${styles.formGroup} ${styles.fullWidth}`}>
                  <label>Địa chỉ Email</label>
                  <div className={styles.inputWrapper}>
                    <Envelope size={18} className={styles.inputIcon} />
                    <input type="email" defaultValue="admin@travelai.com" className={`${styles.input} ${styles.withIcon}`} />
                  </div>
                </div>
                <div className={`${styles.formGroup} ${styles.fullWidth}`}>
                  <label>Giới thiệu tiểu sử</label>
                  <textarea rows={4} defaultValue="Quản trị viên cấp cao của hệ thống Travel AI, phụ trách điều hành và giám sát toàn bộ hoạt động của ứng dụng." className={styles.textarea} />
                </div>
              </div>
            </div>
          )}
                ...
                <div className={styles.formGrid}>
                  <div className={styles.formGroup}>
                    ...
                    <div className={styles.inputWrapper}>
                      ...
                      <input type="password" placeholder="••••••••••••" className={`${styles.input} ${styles.withIcon}`} />
                    </div>
                  </div>
                  <div />
                  <div className={styles.formGroup}>
                    ...
                    <div className={styles.inputWrapper}>
                      <Lock size={18} className={styles.inputIcon} />
                      <input type="password" placeholder="Nhập mật khẩu mới" className={`${styles.input} ${styles.withIcon}`} />
                    </div>
                  </div>
                  <div className={styles.formGroup}>
                    ...
                    <div className={styles.inputWrapper}>
                      <Lock size={18} className={styles.inputIcon} />
                      <input type="password" placeholder="Nhập lại mật khẩu mới" className={`${styles.input} ${styles.withIcon}`} />
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className={styles.twoFactorCard}>
                    <div className={styles.twoFactorInfo}>
                      ...
                      <div>
                        <p className={styles.title}>Xác thực qua thiết bị di động</p>
                        <p className={styles.desc}>Sử dụng các ứng dụng như Google Authenticator.</p>
                      </div>
                    </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
                <div className={styles.settingRow}>
                  <div className={styles.labelBox}>
                    <p className={styles.title}>Chế độ bảo trì (Maintenance Mode)</p>
                    <p className={styles.desc}>Tạm dừng tất cả các hoạt động trên ứng dụng phía người dùng.</p>
                  </div>
                ...
                <div className={styles.settingRow}>
                  <div className={styles.labelBox}>
                    ...
                    <p className={styles.desc}>Gửi thông báo đẩy về các sự kiện quan trọng trong hệ thống.</p>
                  </div>
