      ...
      >
        <div className={styles.imageContainer}>
          ...
          <div className={styles.statusBadge}>
            {status && !isPlaying && (
              <div
                className={`${styles.modernBadge} ${styles[status.toLowerCase()]}`}
              >
                {status === "ACTIVE" ||
                status === "OPENING" ||
                status === "OPEN"
          ...
          {isHot && !isPlaying && <div className={styles.hotTag}>HOT</div>}
          ...
          <button
            ...
            onClick={(e) => {
              ...
              console.log(
                `${localLiked ? "Đã bỏ thích" : "Đã thích"}: ${title}`,
              );
            }}
            aria-label="Yêu thích"
          >
            <Heart size={26} weight={localLiked ? "fill" : "bold"} />
          </button>
