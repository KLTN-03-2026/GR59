...
import styles from "./VoltageButton.module.scss";

interface VoltageButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  children: React.ReactNode;
}

const VoltageButton: React.FC<VoltageButtonProps> = ({ children, className, ...props }) => {
  return (
    <div className={styles.voltageButtonContainer}>
      <div className={styles.voltageButton}>
        ...
        >
          <filter id="glow">
            <feGaussianBlur className={styles.blur} result="coloredBlur" stdDeviation={3} />
          ...
          <path
            className={`${styles.voltage} ${styles.line1}`}
          ...
          />
          <path
            className={`${styles.voltage} ${styles.line2}`}
        ...
        <div className={styles.dots}>
          ...
          <div className={`${styles.dot} ${styles.dot8}`} />
          <div className={`${styles.dot} ${styles.dot9}`} />
          <div className={`${styles.dot} ${styles.dot10}`} />
        </div>
      </div>
    </div>
  );
