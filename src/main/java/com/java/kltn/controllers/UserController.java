...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<ProfileResponse>> updateProfile(@RequestBody @Valid ProfileResponse profileResponse) {
        ProfileResponse updatedUser = userService.updateUserProfile(profileResponse);
    ...
    public ResponseEntity<ApiResponse<Map<String, Boolean>>> changePasswordProfile(
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getAllUsers(
        ...
        Map<String, Object> result = userService.getAllUsers(page, size, search);
        String message = localizationUtils.getLocalizedMessage(MessageKeys.SUCCESS);
